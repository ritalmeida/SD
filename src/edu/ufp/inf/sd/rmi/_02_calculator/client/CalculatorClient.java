...
public class CalculatorClient {
    ...
    private void playService() {
        try {
            ...
            double soma = this.calculatorRI.add(5,2);
            Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Soma (Cliente) = {0}", soma);

            double subtracao = this.calculatorRI.sub(5,2);
            Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Subtracao (Cliente) = {0}", subtracao);

            double multiplicacao = this.calculatorRI.mult(5,2);
            Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Multiplicacao (Cliente) = {0}", multiplicacao);

            double divisao = this.calculatorRI.div(5,2);
            Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Divisao (Cliente) = {0}", divisao);
