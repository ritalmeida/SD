...
public class VisitorServer {
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                elementFolderRI= new ConcreteElementFolderBooksImpl("/Users/Ritaa/Documents/FACULDADE/SISTEMASDISTRIBUIDOS/SD/src/edu/ufp/inf/sd/rmi/_06_visitor/server/Books");
